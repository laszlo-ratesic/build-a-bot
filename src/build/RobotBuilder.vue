...
export default {
  ...
  beforeRouteLeave(to, from, next) {
    if (this.addedToCart) {
      ...
      const response = confirm('You have not added robot to cart. Are you sure you wish to exit?');
      next(response);
    }
  },
  components: { PartSelector, CollapsibleSection },
  // any data you want to bind to MUST be initialized in the data function
  data() {
    return {
      availableParts,
      addedToCart: false,
